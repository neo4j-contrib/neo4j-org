...
//            img: "",
    ...
    <li>Recognition as an innovator and thought leader in the NoSQL space\
        ...
        nosql: {
            ...
            keyvalue: {
                ...
                content: "\
                    <div><img src="+asset('img/propertygraph/vs-key-value.png')+" alt='' title='vs-key-value' width='245' height='76' /><img src="+asset('img/propertygraph/vs-document.png')+" alt='' title='as-key-value' width='264' height='163' /></div>\
    ...
    books: {
        graphdatabases: {
            ...
            logo: asset("new/img/graphdatabases_v31.png"),
